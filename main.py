...
Original file is located at
    https://colab.research.google.com/drive/1n09nLks9VW61pTAZm64uw1WkGLMTBYGM
...
surname = input("Now the surname!!!!: ")
age = int(input("The age!!!!: "))

print(f'Your name is believed to be {name}, with surname - {surname}, living for {age} years, and years to come.')
...
print("Your polish grade is:", grade)
...
if number1 % number2 == 0:
    print("You are lucky! The first number is divisible by second number.")
else:
    print("Unfortunately the first number is not divisible by second.")
...
not_triangle = (side1 + side2 <= side3) | (side1 + side3 <= side2) | (side2 + side3 <= side1)
if not_triangle:
    print("Unfortunately your figure is not a triangle.")
else:
    print("Yay! You have a triangle.")
